...
from app.api.handlers.operators import create_operator_handler, get_operator_handler, update_operator_handler, \
    delete_operator_handler, get_operators_list_handler
...
operators_routes.get("/operators/")(get_operators_list_handler)
operators_routes.patch("/operators/{operator_id}")(update_operator_handler)
operators_routes.delete("/operators/{operator_id}")(delete_operator_handler)